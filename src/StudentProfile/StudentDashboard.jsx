...
import { FaTrophy, FaStar, FaTasks, FaMedal, FaRocket } from "react-icons/fa";
...
{/* <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 p-6 rounded-lg shadow-xl hover:shadow-2xl hover:scale-105 hover:rotate-1 transition-transform duration-300 text-center">
<h3 className="text-xl font-semibold mb-4 animate-slide-up">
  Your Badges
</h3>
<div className="flex justify-center space-x-4">
  <FaStar className="text-white text-3xl animate-spin" />
